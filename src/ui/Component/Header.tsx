    ...
    <header className="header">
      ...
      <section className="header-section-nav" >
        <span
            ...
            style={filter === 0 ? {backgroundColor : "#E5E7EB" , color: "#1F2937"} : {}}
        >{filter_map[0].toString()}</span>
        <span
        
        onClick={() => handleChangeTab(1)}
        style={filter === 1 ? {backgroundColor : "#E5E7EB" , color: "#1F2937"} : {}}

        >{filter_map[1].toString()}</span>
        <span
        
        onClick={() => handleChangeTab(2)}
        style={filter === 2 ? {backgroundColor : "#E5E7EB" , color: "#1F2937"} : {}}
